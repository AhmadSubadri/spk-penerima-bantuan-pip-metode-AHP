...
class Auth extends CI_Controller
{
	...
	public function index()
	{
		...
		} elseif (!$this->ion_auth->is_admin()) // remove this elseif if you want to enable this for non-admins
		{
			...
			$this->load->view('dashboard/content/auth/index', $this->data);
	...
	public function forgot_password()
	{
		...
		if ($this->config->item('username', 'ion_auth') != 'email') {
			$this->form_validation->set_rules('username', $this->lang->line('forgot_password_identity_label'), 'required');
		} else {
			$this->form_validation->set_rules('username', $this->lang->line('forgot_password_validation_email_label'), 'required|valid_email');
		}


		if ($this->form_validation->run() == false) {
			$this->data['type'] = $this->config->item('username', 'ion_auth');
			// setup the input
			$this->data['username'] = array(
				'name' => 'username',
				'id' => 'username',
			...
			$identity_column = $this->config->item('username', 'ion_auth');
			...
			$forgotten = $this->ion_auth->forgotten_password($identity->{$this->config->item('username', 'ion_auth')});
		...
		if ($user) {
			...
			if ($this->form_validation->run() == false) {
				...
				if ($this->_valid_csrf_nonce() === FALSE || $user->id != $this->input->post('user_id')) {
					...
					$identity = $user->{$this->config->item('username', 'ion_auth')};
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE) {
			...
			$this->load->view('dashboard/partials_/header');
			$this->load->view('dashboard/content/auth/deactivate_user', $this->data);
			$this->load->view('dashboard/partials_/footer');
	...
	public function create_user()
	{
		...
		if ($this->form_validation->run() == true && $this->ion_auth->register($identity, $password, $email, $additional_data)) {
			...
			$this->load->view('dashboard/partials_/header');
			$this->load->view('dashboard/content/auth/create_user', $this->data);
			$this->load->view('dashboard/partials_/footer');
	...
	public function edit_user($id)
	{
		...
		$this->load->view('dashboard/partials_/header');
		$this->load->view('dashboard/content/auth/edit_user', $this->data);
		$this->load->view('dashboard/partials_/footer');
	...
	public function create_group()
	{
		...
		if ($this->form_validation->run() == TRUE) {
			...
			$this->load->view('dashboard/partials_/header');
			$this->load->view('dashboard/content/auth/create_group', $this->data);
			$this->load->view('dashboard/partials_/footer');
	...
	public function edit_group($id)
	{
		...
		$this->load->view('dashboard/partials_/header');
		$this->load->view('dashboard/content/auth/edit_group', $this->data);
		$this->load->view('dashboard/partials_/footer');
